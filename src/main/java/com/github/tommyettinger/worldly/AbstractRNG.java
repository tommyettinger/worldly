...
/**
 * A helper class for making a random number generator without so much busy-work.
 * You need to provide implementations for the abstract methods {@link #nextInt()}, {@link #next(int)},
 * {@link #nextLong()}, {@link #nextBoolean()}, {@link #nextDouble()}, {@link #nextFloat()}, and {@link #copy()}, many
 * of which may be built off of each other and some of which have sample code in their
...
public abstract class AbstractRNG {
     ...
     */
    public abstract AbstractRNG copy();
}
