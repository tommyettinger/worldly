...
import static com.github.tommyettinger.worldly.StringKit.hex;

/**
 * A random number generator that is optimized for producing int and float values, especially on GWT. 
 * <br>
 * Written in 2019 by Tommy Ettinger.
 * @author Tommy Ettinger
 */
public final class SilkRNG extends AbstractRNG implements Serializable {
    ...
    /**
     * Hashes {@code seed} using {@link String#hashCode()} with {@link #setState(long)}. If seed is null, this won't call
     * String.hashCode() on it and will instead pass 0 to setState().
     * @param seed any String; may be null
     */
    public SilkRNG(final String seed) {
        setState(seed == null ? 0L : seed.hashCode());
    }
    ...
    public String toString() {
        return "SilkRNG with stateA 0x" + hex(stateA) + " and stateB 0x" + hex(stateB);
    }
